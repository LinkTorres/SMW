...
<div class="row">
    ...
    <center><h2>Sueldo quincenal</h2></center>
...
<div class="table-responsive">
    ...
    <table class="table table-hover table-bordered">
        <thead>
            <tr>
                <th>Empleado</th>
                <th>Sueldo Total</th>
                <th>Sueldo Tarjeta</th>
                <th>Sueldo Efectivo</th>
                <th>Carga Social</th>
                <th>Costo Total</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($nomina as $empleado)
                <tr>
                    ...
                    <td><script>document.write(numeral({{ $empleado->sueldoTotal }}).format('$ 0,0.00'));</script></td>
                    <td><script>document.write(numeral({{ $empleado->sueldoTarjeta }}).format('$ 0,0.00'));</script></td>
                    <td><script>document.write(numeral({{ $empleado->sueldoEfectivo }}).format('$ 0,0.00'));</script></td>
                    <td><script>document.write(numeral({{ $empleado->cargaSocial }}).format('$ 0,0.00'));</script></td>
                    <td><script>document.write(numeral({{ $empleado->costoTotal }}).format('$ 0,0.00'));</script></td>
                </tr>
            @endforeach
          <tr>
          </tr>  
    ...
    <a href="./pagarNomina" class="btn btn-danger">Pagar Nómina</a>
