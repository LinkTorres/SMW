    ...
    <div class="container">  
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li><input class="form-control input-lg-3" placeholder="Buscar"></input></li>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  </nav>
      ...
      <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar menu">
          <li>  </li>
            ...
            <li>  {{ HTML::link('clientesM', 'Clientes', array('class' => 'list-group-item')); }}                      </li>
            <li>  {{ HTML::link('zonas', 'Zonas', array('class' => 'list-group-item')); }}                      </li>
            <li>  {{ HTML::link('rutas', 'Rutas', array('class' => 'list-group-item')); }}                      </li>
            ...
            <li>  {{ HTML::link('lavado', 'Lavado', array('class' => 'list-group-item')); }}                      </li>
            <li>  {{ HTML::link('planchado', 'Planchado', array('class' => 'list-group-item')); }}                      </li>
