...
<div ng-app="Monitor">
{{ Form::open(['route'=>'create.planchado', 'method'=>'POST', 'role' => 'form','novalidate', 'id'=>'frm_pedido']) }}
	...
	<div class="panel panel-default">
  		<div class="panel-heading">Planchado</div>
  		<div class="panel-body">
	    	<div class="row">
				<div class="col-md-3">	
		    		<div class="form-group">
					   	{{  Form::label('piezas', 'Piezas') }}
					   	{{  Form::text('piezas' ,null, ['class' => 'form-control', 'onkeypress'=>'return numeros(event);', 'onkeyup'=> 'costo(2)'])}}
					   	{{ $errors->first('piezas','<p class="message_error">:message</p>') }}
					</div>
				</div>
				<div class="col-md-6">
					Costo
