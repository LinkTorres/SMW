    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
                    ...
                    <div class="ibox-content">
                        {{ Form::open(['route'=>'alrededores', 'method'=>'POST', 'role' => 'form','novalidate', 'id'=>'form-horizontal',  'class'=>'form-horizontal']) }}
                                <div class="form-group"><label class="col-lg-2 control-label">Numero de Nota</label>

                                    <div class="col-lg-10">{{  Form::text('nota',null, ['class' => 'form-control','placeholder' => 'Nota', 'required' => 'required'])}}
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Lavado</label>
                                    ...
                                    <div class="col-lg-10">
                                        {{  Form::text('kilos',null, ['class' => 'form-control','placeholder' => 'Kilos','onkeydown'=>'costoTotal();', 'id' => 'kilos', 'required'])}}</div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Lavado</label>

                                    <div class="col-lg-10">
                                        {{  Form::text('kilos2',null, ['class' => 'form-control','placeholder' => 'Piezas','onkeydown'=>'costoTotal();', 'id' => 'kilos', 'required'])}}</div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Planchado</label>

                                    <div class="col-lg-10">{{  Form::text('piezas',null, ['class' => 'form-control','placeholder' => 'Piezas','onkeydown'=>'costoTotal();', 'id' => 'piezas', 'required'])}}</div>
                                </div>
                                 <div class="form-group"><label class="col-lg-2 control-label">Costo</label>

                                    <div class="col-lg-10"><label id="costo2" name="costo2" class="hidden">$</label>{{  Form::text('costo',null, ['class' => 'form-control', 'id' => 'costo3', 'required'])}}</div>

                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Fecha</label>

                                    <div class="col-lg-10">
                                        {{  Form::text('fecha',null, ['class' => 'form-control datepicker','placeholder' => 'Fecha', 'id' => 'fecha', 'required'])}}</div>
                                </div>
			...
			<div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                        @foreach ($aledanos as $aledano)
                        <tr>
                            <td>{{  $aledano->id   }}</td>
                           <td><a href="edicionAlrededores/{{  $aledano->id   }}">{{  $aledano->numNota   }}</a></td>
                           <td>{{  $aledano->fecha   }}</td>
                            <td>{{  $aledano->nombre   }}</td>
                            <td>{{  $aledano->kilos   }}</td>
                            <td>{{  $aledano->kilos2   }}</td>
                            <td>{{  $aledano->piezas   }}</td>
                             <td>{{  $aledano->costo   }}</td>
                        </tr>
                        @endforeach
                    </tbody>
