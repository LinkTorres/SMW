    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
                    ...
                    <div class="ibox-content">
                      {{ Form::open(['route'=>'corporativo2', 'method'=>'POST', 'role' => 'form','novalidate', 'id'=>'form-horizontal',  'class'=>'form-horizontal']) }} 
                            <div class="form-group"><label class="col-lg-2 control-label">Empresa</label>

                                    <div class="col-lg-10">{{  Form::select('empresa', array($array),null, ['class' => 'form-control', 'required' => 'required'])  }}
                                    </div>
                            </div>
                             <div class="form-group"><label class="col-lg-2 control-label">Empleado</label>

                                    <div class="col-lg-10">{{  Form::text('nombre',null, ['class' => 'form-control','placeholder' => 'Nombre del Empleado', 'required' => 'required'])}}
                                    </div>
                            </div>
                             <div class="form-group"><label class="col-lg-2 control-label">Telefono</label>

                                    <div class="col-lg-10">{{  Form::text('telefono',null, ['class' => 'form-control','placeholder' => 'Telefono', 'required' => 'required'])}}
                                    </div>
                            </div>
                             <div class="form-group"><label class="col-lg-2 control-label">Correo</label>

                                    <div class="col-lg-10">{{  Form::text('correo',null, ['class' => 'form-control','placeholder' => 'Correo', 'required' => 'required'])}}
                                    </div>
                            </div>
                             <div class="form-group"><label class="col-lg-2 control-label">Cumpleaños</label>

                                    <div class="col-lg-10">{{  Form::text('cumpleanos',null, ['class' => 'form-control datepicker','placeholder' => 'Fecha de Cumpleaños', 'required' => 'required'])}}
                                    </div>
                            </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Catálogo de Empleados Corporativos</h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
