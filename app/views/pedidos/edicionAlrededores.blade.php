    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
                    ...
                    <div class="ibox-content">
                        {{ Form::open(['route'=>'edicionAlrededores'.$aledano3->id, 'method'=>'POST', 'role' => 'form','novalidate', 'id'=>'form-horizontal',  'class'=>'form-horizontal']) }}
                                <div class="form-group"><label class="col-lg-2 control-label">Numero de Nota</label>

                                    <div class="col-lg-10">{{  Form::text('nota',$aledano3->numNota, ['class' => 'form-control','placeholder' => 'Nota', 'required' => 'required'])}}
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Nombre</label>
                                    ...
                                    -->
                                    <div class="col-lg-10">{{  Form::select('nombre', $array,$aledano3->nombre, ['class' => 'form-control select', 'required' => 'required'])  }}
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Lavado</label>
                                    ...
                                    <div class="col-lg-10">
                                        {{  Form::text('kilos',$aledano3->kilos, ['class' => 'form-control','placeholder' => 'Kilos','onkeydown'=>'costoTotal();', 'id' => 'kilos', 'required'])}}</div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Lavado</label>

                                    <div class="col-lg-10">
                                        {{  Form::text('kilos2',$aledano3->kilos2, ['class' => 'form-control','placeholder' => 'Piezas','onkeydown'=>'costoTotal();', 'id' => 'kilos', 'required'])}}</div>
                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Planchado</label>

                                    <div class="col-lg-10">{{  Form::text('piezas',$aledano3->piezas, ['class' => 'form-control','placeholder' => 'Piezas','onkeydown'=>'costoTotal();', 'id' => 'piezas', 'required'])}}</div>
                                </div>
                                 <div class="form-group"><label class="col-lg-2 control-label">Costo</label>

                                    <div class="col-lg-10"><label id="costo2" name="costo2" class="hidden">$</label>{{  Form::text('costo',$aledano3->costo, ['class' => 'form-control', 'id' => 'costo3', 'required'])}}</div>

                                </div>
                                <div class="form-group"><label class="col-lg-2 control-label">Fecha</label>

                                    <div class="col-lg-10">
                                        {{  Form::text('fecha',$aledano3->fecha, ['class' => 'form-control datepicker','placeholder' => 'Fecha', 'id' => 'fecha', 'required'])}}</div>
                                </div>
