    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
                    ...
                    <div class="ibox-content">
                       {{ Form::open(['route'=>'corporativo1', 'method'=>'POST', 'role' => 'form','novalidate', 'id'=>'form-horizontal',  'class'=>'form-horizontal']) }} 
                            <div class="form-group"><label class="col-lg-2 control-label">Empresa</label>

                                    <div class="col-lg-10">{{  Form::text('Empresa',null, ['class' => 'form-control','placeholder' => 'Nombre de la Empresa', 'required' => 'required'])}}
                                    </div>
                            </div>
                            <div class="form-group"><label class="col-lg-2 control-label">Nombre del Contacto</label>

                                    <div class="col-lg-10">{{  Form::text('nombre',null, ['class' => 'form-control','placeholder' => 'Nombre del Contacto', 'required' => 'required'])}}
                                    </div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label">Dirección</label>
                                    ...
                                    <div class="col-lg-10">{{  Form::text('Direccion',null, ['class' => 'form-control','placeholder' => 'Direccion', 'required' => 'required'])}}
                                    </div>
                            </div>
