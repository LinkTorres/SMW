...
<div class="row">
    ...
    <center><h2>Consolidado de Ingresos Semanal</h2></center>
          ...
          <tr>
            ...
            <script type="text/javascript">
                ...
                for(i=1; i<=52; i++)
                {
                    /*
                    @for ($i = 0; $i < 2; $i++)
                        if(i== {{ $semanasAledanos[$i]->semana }})
                        {
                            document.write("<td>{{ $semanasAledanos[$i]->costo }}</td>")
                        }
                        else{
                    ...
                    */
                    ...
                    var ar = <?php echo $array ?>;


                    if(ar[i]!=undefined){
                    document.write("<td>"+ numeral(ar[i]).format('$ 0,0.00') +"</td>");
                    }
                    else{
                            document.write("<td>"+numeral(0).format('$ 0,0.00')+"</td>")
                        }
            ...
            <script type="text/javascript">
                ...
                for(i=1; i<=52; i++)
                {
                    ...
                    */
                    ...
                    var ar1 = <?php echo $array1 ?>;


                    if(ar1[i]!=undefined){
                    document.write("<td>"+ numeral(ar1[i]).format('$ 0,0.00') +"</td>");
                    }
                    else{
                            document.write("<td>"+numeral(0).format('$ 0,0.00')+"</td>")
                        }
            ...
            <script type="text/javascript">
                ...
                for(i=1; i<=52; i++)
                {
                    ...
                    */
                    ...
                    var ar2 = <?php echo $array2 ?>;


                    if(ar2[i]!=undefined){
                    document.write("<td>"+ numeral(ar2[i]).format('$ 0,0.00') +"</td>");
                    }
                    else{
                            document.write("<td>"+numeral(0).format('$ 0,0.00')+"</td>")
                        }
            ...
            <script type="text/javascript">
                ...
                for(i=1; i<=52; i++)
                {
                    ...
                    */
                    ...
                    document.write("<td>"+ numeral(total).format('$ 0,0.00') +"</td>");
