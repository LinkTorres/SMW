...
<div class="row">
    ...
    <center><h2>Consolidado Nómina Quincenal</h2></center>
    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
           @foreach ($nomina as $empleado)
                <tr>
                    <td><script>document.write(numeral({{ $empleado->numQuincena }}).format('0'));</script></td>
                    <td><script>document.write(numeral({{ $empleado->total }}).format('$ 0,0.00'));</script></td>
                    <td><script>document.write(numeral({{ $empleado->cargaSocial }}).format('$ 0,0.00'));</script></td>
                    <td><script>document.write(numeral({{ $empleado->numTrabajadores }}).format('0'));</script></td>
                </tr>
            @endforeach
